...
4. 定位代码前读 [CODEBASE_MAP.md](/Users/yuchao/Documents/GitHub/Glimmer/docs/ai-handoff/CODEBASE_MAP.md)：先看哪里，哪些大目录不要默认读。
5. 动手前读 [GUARDRAILS.md](/Users/yuchao/Documents/GitHub/Glimmer/docs/ai-handoff/GUARDRAILS.md)：哪些地方不能乱动，最低验证要求是什么。
6. 遇到历史兼容、同步、UI 反复迭代问题时读 [LESSONS_LEARNED.md](/Users/yuchao/Documents/GitHub/Glimmer/docs/ai-handoff/LESSONS_LEARNED.md)。
